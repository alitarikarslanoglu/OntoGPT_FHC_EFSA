...
class Ingredient(NamedEntity):
    ...
    frequency: Optional[string] = Field(None, description="""How often the ingredient is consumed""")
...
class Dose(ConfiguredBaseModel):
    has_unit: Optional[string] = Field(None, description="""The unit of the dose""")
...
class TargetPopulation(NamedEntity):
    has_quality: Optional[string] = Field(None, description="""The biological quality of the target population""")
    id: str = Field(..., description="""A unique identifier for the named entity""")
    label: Optional[str] = Field(None, description="""The label (name) of the named thing""")


class Evidence(ConfiguredBaseModel):
    evidence_for: Optional[str] = Field(None, description="""The statement or claim supported by the evidence""")
    cites: Optional[str] = Field(None, description="""The reference cited as evidence""")
